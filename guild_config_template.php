...
}else $command_symbol	= strval(VarLoad($guild_folder, "command_symbol.php"));
...
}else $welcome_log_channel_id	= strval(VarLoad($guild_folder, "welcome_log_channel_id.php"));
...
}else $welcome_public_channel_id	= strval(VarLoad($guild_folder, "welcome_public_channel_id.php"));
...
}else $general_channel_id	= strval(VarLoad($guild_folder, "general_channel_id.php"));
...
}else $rolepicker_channel_id	= strval(VarLoad($guild_folder, "rolepicker_channel_id.php"));
...
}else $suggestion_pending_channel_id	= strval(VarLoad($guild_folder, "suggestion_pending_channel_id.php"));
...
}else $suggestion_approved_channel_id	= strval(VarLoad($guild_folder, "suggestion_approved_channel_id.php"));
...
}else $role_18_id	= strval(VarLoad($guild_folder, "role_18_id.php"));
...
}else $role_verified_id	= strval(VarLoad($guild_folder, "role_verified_id.php"));
...
}else $role_dev_id	= strval(VarLoad($guild_folder, "role_dev_id.php"));
...
}else $role_owner_id	= strval(VarLoad($guild_folder, "role_owner_id.php"));
...
}else $role_admin_id	= strval(VarLoad($guild_folder, "role_admin_id.php"));
...
}else $role_mod_id	= strval(VarLoad($guild_folder, "role_mod_id.php"));
...
}else $role_bot_id	= strval(VarLoad($guild_folder, "role_bot_id.php"));
...
}else $role_vzgbot_id	= strval(VarLoad($guild_folder, "role_vzgbot_id.php"));
...
}else $role_muted_id	= strval(VarLoad($guild_folder, "role_muted_id.php"));
...
}else $species_message_id	= strval(VarLoad($guild_folder, "species_message_id.php"));
...
}else $sexuality_message_id	= strval(VarLoad($guild_folder, "sexuality_message_id.php"));
...
}else $gender_message_id	= strval(VarLoad($guild_folder, "gender_message_id.php"));
...
}else $customroles_message_id	= strval(VarLoad($guild_folder, "customroles_message_id.php"));
?>
