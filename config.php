<?php
//These are static variables that should be set when the bot is first added to the server.
...
//$watch_channel_id = "";			//Someone being watched has their messages duplicated to this channel instead of a DM
